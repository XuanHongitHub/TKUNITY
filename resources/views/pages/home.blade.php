        ...
        <div class="games-slider-wrapper">
            <div class="games-slider" id="gamesSlider">
                ...
                <a href="#" class="game-card">
                    <div class="game-card-inner">
                        <div class="game-card-visual">
                            <div class="game-card-bg game-placeholder" style="background: linear-gradient(135deg, #f97316 0%, #ea580c 50%, #1a0a1a 100%);">
        ...
        <div class="how-wrapper">
            ...
            <div class="how-right">
                <div class="device-mockups">
                    <img src="{{ setting_url('process_mockup', 'images/tkunity_devices.webp') }}" alt="{{ setting('site_name', 'TKUnity') }} Process" class="mockup-composite">
                </div>
            </div>
        </div>
    </section>
